...
<!-- Initial Loader สำหรับหน้า index.php -->
<div id="initial-loader" style="position: fixed; inset: 0; background: #f8fafc; z-index: 9999; display: flex; flex-direction: column; align-items: center; justify-content: center; transition: opacity 0.5s ease;">
    <div style="color: #1e293b; font-size: 1.1rem; font-weight: 700; margin-bottom: 15px; letter-spacing: 0.05em; animation: pulseText 1.5s infinite;" id="loader-text">กำลังโหลดข้อมูล...</div>
    <div style="width: 220px; height: 4px; background: #e2e8f0; border-radius: 4px; overflow: hidden;">
        <div style="width: 0%; height: 100%; background: #e11d48; border-radius: 4px; animation: loadingBarAnim 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards;"></div>
    </div>
</div>
<style>
