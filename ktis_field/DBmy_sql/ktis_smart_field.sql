...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2026 at 04:22 AM
...
INSERT INTO `employee` (`ID`, `emp_id`, `emp_pass`, `emp_name`, `emp_unit`, `emp_level`, `is_harvester_manager`, `status`, `created_at`, `updated_at`) VALUES
(1, 'admin01', '$2y$10$gPNxiSOw2OdIydgWVFIuJ.wAhZbm/yiGebC54iarBlLARG3eIuSme', 'ผู้จัดการ ออฟฟิศกลาง', 'ประจำออฟฟิตกลาง', 'a', 0, 1, '2026-07-11 09:23:07', NULL),
(5, 'TIS-111', '$2y$10$0RpaCzmHYe7OoferVkB9s.GqS0VQ9JcsPBQK/BxsgaBL2ebBMlGem', 'นายพัชกร จันทนะโพธิ', '111 บางขลัง', 'u', 1, 1, '2026-07-11 09:23:07', NULL),
(6, 'TIS-131', '$2y$10$9NXd4VDroO5dCpH22ltbtOcUdQ4Nz8gmdVG/0fBKmULFCkAyHTQiC', 'นายไพโรจ์', '131 ศรีนครเหนือ', 'u', 1, 1, '2026-07-11 09:23:07', '2026-07-11 09:23:31');
...
INSERT INTO `employee_harvester` (`id`, `emp_id`, `harvester_id`, `assigned_at`) VALUES
(12, '5', 9, '2026-07-11 13:40:57'),
(13, '5', 5, '2026-07-11 13:40:57'),
(14, '5', 1, '2026-07-11 13:40:58');
...
(45, 34, 'TIS-111', '111 บางขลัง', 'แจ้งรถสกปรก: สท80-1428 (รถตัดเบอร์ 1) — อ้อยไฟไหม้ / ใบอ้อยเยอะ', 1, '2026-07-13 02:48:53');
...
INSERT INTO `posts` (`post_id`, `emp_id`, `target_unit`, `truck_number`, `harvester_number`, `post_text`, `problem_detail`, `problem_detail_2`, `problem_detail_3`, `post_image`, `post_image_2`, `post_image_3`, `crop_year`, `job_status`, `created_at`, `updated_at`) VALUES
(34, 'admin01', '111 บางขลัง', 'สท80-1428', 'รถตัดเบอร์ 1', '', 'อ้อยไฟไหม้', 'ใบอ้อยเยอะ', NULL, 'uploads/2026-07-13/p1_1783910933_7192.jpg', 'uploads/2026-07-13/p2_1783910933_9218.jpg', 'uploads/2026-07-13/p3_1783910933_5340.jpg', '69/70', 'pending', '2026-07-13 02:48:53', NULL);
...
(249, 'admin01', 'CREATE_POST', '34', 'สร้างโพสต์ #34 หน่วย:111 บางขลัง รถ:สท80-1428 รถตัด:รถตัดเบอร์ 1 ปัญหา:อ้อยไฟไหม้ / ใบอ้อยเยอะ', '2026-07-13 02:48:53');
...
--
ALTER TABLE `notifications`
  MODIFY `noti_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
