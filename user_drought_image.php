...
<head>
    ...
    <title>TIS WaterSuga - รูปภาพกระทบแล้ง</title>
...
<div class="content-wrapper">
    <div class="container mt-5">
        ...
        <h5 class="text-center">
            <i class='bx bx-sun'></i> ข้อมูลแปลงอ้อยที่มีรูปภาพกระทบแล้ง
        </h5>
        ...
        <div class="table-responsive">
            <table id="dataTable" class="table table-striped table-bordered nowrap" style="width:100%">
                ...
                <tbody>
                    <?php
                    // ปรับ SQL ให้กรองตาม emp_id และ year_rai ที่เลือก และต้องมี drought_image
                    ...
                    $sql_data = "SELECT * FROM image_water 
                                 ...
                                 AND (`drought_image` IS NOT NULL AND `drought_image` != '')
                                 ORDER BY plot_id";
                    ...
                    // --- แก้ไขจุดนี้: ทำเลขสัญญาให้เป็น 6 หลัก ---
                        ...
                        echo "<td>
                                <a href='user_water_edit_data.php?plot_id=" . urlencode($row_data['plot_id']) . "' class='btn btn-warning btn-sm'><i class='bx bx-edit-alt'></i></a>
                            </td>
                        </tr>";
                    }
                    ?>
        ...
        $(document).ready(function() {
            $('#dataTable').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: "ไม่พบข้อมูลในปีการผลิตที่เลือก",
