...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2026 at 06:43 AM
...
(2, 'field111', '$2y$10$eBqvZnMfEztnbOUJ1LlYQe9cTGpj9y7C39uNJmNYrSyKS69oEYpai', 'พนักงาน', '111 บางขลัง', 'u'),
...
(10, 12, 'field111', '111 บางขลัง', 'ออฟฟิศกลางแจ้งตรวจสอบรถอ้อย: ทะเบียน สท80-1427', 1, '2026-06-06 03:57:33'),
...
(13, 13, 'field111', '111 บางขลัง', 'แจ้งรถสกปรก: สท80-1427 — อ้อยไฟไหม้ / ใบอ้อยเยอะ / ใบอ้อยเยอะ', 0, '2026-06-08 03:40:51'),
(14, 13, 'TIS-111', '111 บางขลัง', 'แจ้งรถสกปรก: สท80-1427 — อ้อยไฟไหม้ / ใบอ้อยเยอะ / ใบอ้อยเยอะ', 1, '2026-06-08 03:40:51'),
(15, 14, 'field111', '111 บางขลัง', 'แจ้งรถสกปรก: สท80-1427 — อ้อยเกินน้ำหนักบรรทุก / ใบอ้อยเยอะ / อ้อยไฟไหม้', 0, '2026-06-08 03:41:22'),
...
(14, 'admin01', '111 บางขลัง', 'สท80-1427', '', 'อ้อยเกินน้ำหนักบรรทุก', 'ใบอ้อยเยอะ', 'อ้อยไฟไหม้', 'uploads/2026-06-08/p1_1780890082_9679.jpg', NULL, NULL, '69/70', 'success', '2026-06-08 03:41:22', '2026-06-08 03:47:15');
...
(3, 2, 'field111', NULL, NULL, 'p9595', 'uploads/2026-06-05/reply_1780646223_7412.png', '2026-06-05 08:09:43', '2026-06-05 08:09:43'),
(4, 12, 'field111', 'พนักงาน', '111 บางขลัง', 'แก้เรียบร้อยแล้ว', 'uploads/2026-06-06/reply_1780718293_6a239ad545867.png', '2026-06-06 03:58:13', NULL),
...
(1, 3, 'หกหกห', NULL, '2026-06-05 08:05:24'),
(2, 3, 'pppppp', NULL, '2026-06-05 08:05:49'),
(3, 3, 'pp99', '2026-06-05 08:05:49', '2026-06-05 08:09:29'),
(4, 3, 'pp9999944', '2026-06-05 08:09:29', '2026-06-05 08:09:43'),
...
--
ALTER TABLE `notifications`
  MODIFY `noti_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `problem_types`
  MODIFY `problem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
