    ...
    <div class="footer-container">
        <div class="footer-left">
            ...
            <div class="company-info">
                ...
                <span class="company-address">42/1 หมู่ที่ 8 บ้านหาดเสือเต้น ตำบลคุ้งตะเภา อำเภอเมืองอุตรดิตถ์ จังหวัดอุตรดิตถ์</span>
            </div>
        </div>
        <div class="footer-right">
            ...
            <div class="dev-credit">🌱 LINE : Supanat_SK.</div>
            <div class="version-info">Version 1.1.0 © <?php echo date("Y"); ?> All Rights Reserved</div>
        </div>
    </div>
</footer>
...
<style>
   ...
   .main-footer-custom {
    ...
    z-index: 100;       /* เพิ่มค่าให้สูงกว่า Sidebar (ซึ่งเราตั้งไว้ 50) */
