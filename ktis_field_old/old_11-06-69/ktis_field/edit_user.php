...
<head>
    ...
    <title>แก้ไขพนักงาน - KTIS SMART FIELD</title>
...
<div class="page-container">
    ...
    <form method="POST">
        ...
        <div class="form-group">
            <label for="emp_unit">หน่วยงาน</label>
            <input type="text" id="emp_unit" name="emp_unit" value="<?php echo htmlspecialchars($employee['emp_unit']); ?>" required>
            <div class="help-text">เช่น แผนก IT, แผนก HR เป็นต้น</div>
        </div>
