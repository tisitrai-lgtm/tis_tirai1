...
<head>
    ...
    <link rel="stylesheet" href="includes/nav_custom.css">
</head>
<body>
...
<nav class="main-navbar">
    ...
    <a href="index.php" class="nav-logo" style="text-decoration:none;color:inherit;">
        ...
        <span class="logo-full">KTIS <span style="color:#e11d48;">SMART FIELD</span></span>
        <span class="logo-short" style="display:none;color:#e11d48;">KTIS</span>
    </a>
    ...
    <div class="nav-menu" id="navMenu">
        ...
        <div class="nav-admin-group" id="adminNavGroup">
            ...
            <div class="nav-admin-dropdown">
                ...
                <span class="nav-dropdown-label">ภาพรวม</span>
                ...
                <span class="nav-dropdown-label">รายงาน</span>
                ...
                <hr class="nav-dropdown-divider">
                <span class="nav-dropdown-label">จัดการ</span>
...
<script src="includes/nav_script.js"></script>