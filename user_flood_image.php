...
<head>
    ...
    <title>TIS WaterSuga - รูปภาพน้ำท่วม</title>
...
<div class="content-wrapper">
    <div class="container mt-5">
        ...
        <h5 class="text-center">
            <i class='bx bx-cloud-rain'></i> ข้อมูลแปลงอ้อยที่มีรูปภาพน้ำท่วม
        </h5>
        ...
        <div class="table-responsive">
            <table id="dataTable" class="table table-striped table-bordered nowrap" style="width:100%">
                ...
                <tbody>
                    <?php
                    // --- ➕ ปรับ SQL ให้กรองตาม emp_id, year_rai ที่เลือก และต้องมี flood_image ---
                    ...
                    $sql_data = "SELECT * FROM image_water 
                                 ...
                                 AND (`flood_image` IS NOT NULL AND `flood_image` != '')
                                 ORDER BY plot_id";
                    // ----------------------------------------------------------------------
        ...
        $(document).ready(function() {
            $('#dataTable').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: "ไม่พบข้อมูลน้ำท่วมในปีการผลิตที่เลือก",
