...
<head>
    ...
    <style>
        ...
        body, html {
            ...
            /* 🚨 แก้ไขตรงนี้สำหรับภาพพื้นหลังเดียว เต็มจอ */
            background-image: url('icon/bg.jpg'); 
            background-repeat: no-repeat; /* ไม่ต้องทำซ้ำ */
            background-size: cover;      /* ครอบคลุมเต็มพื้นที่ */
            background-position: center center; /* จัดตำแหน่งกึ่งกลาง */
            background-attachment: fixed; /* ตรึงภาพพื้นหลังเมื่อ Scroll (ไม่จำเป็นถ้าเนื้อหาน้อย) */
        }
        
        /* Overlay สำหรับภาพพื้นหลังเพื่อลดความเข้ม */
        body::before {
            content: '';
            position: fixed;
            top: 0;
        ...
        .container {
            ...
            padding: 20px;
            position: relative;
            z-index: 1; /* ทำให้ Card อยู่เหนือ Overlay */
        }
        .system-title {
            font-size: 2.5rem;
            font-weight: 700;
...
<div class="container">
    <h1 class="system-title">ระบบรูปใส่แปลงประมาณตัน [ Admin ]</h1>
    ...
    <div class="card">
        ...
        <form action="dashboard.php" method="get">
            ...
            <button type="submit" class="btn btn-primary w-100">เข้าสู่ระบบ</button> <br><br>
            <a href="user_index.php">ไปหน้าเข้าใช้งานผู้ใช้</a>
        </form>
    </div>
</div>
