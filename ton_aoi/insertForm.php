                ...
                <form action="insertData.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6"><label for="plot_id" class="form-label">ID แปลง <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="plot_id" name="plot_id" required placeholder="เช่น 0101-001">
                        </div>
                        <div class="col-md-6"><label for="contract_number" class="form-label">เลขสัญญา</label>
                            <input type="text" class="form-control" id="contract_number" name="contract_number" placeholder="ถ้ามี">
                        </div>
                        ...
                        <div class="col-md-6"><label for="emp_number" class="form-label">นักส่งเสริม</label>
                            <input type="text" class="form-control" id="emp_number" name="emp_number" placeholder="ชื่อหรือรหัสนักส่งเสริม">
                        </div>
                    ...
                    <?php
                    $section2_images = [
                        "evaluate_ton_1" => "ประเมินตันอ้อยเบื้องต้น (รูปที่ 1)",
                        "evaluate_ton_2" => "ประเมินตันอ้อยเบื้องต้น (รูปที่ 2)",
                    ];
                    createImageUploads("1. ประเมินตันอ้อยเบื้องต้น", $section2_images, 'bi-rulers');
                    ?>
                    
                    <?php
                    $section1_images = [
                        "estimate_ton_1" => "ประมาณตันอ้อยก่อนเปิดหีบ (รูปที่ 1)",
                        "estimate_ton_2" => "ประมาณตันอ้อยก่อนเปิดหีบ (รูปที่ 2)",
                    ];
                    createImageUploads("2. ประมาณตันอ้อยก่อนเปิดหีบ", $section1_images, 'bi-pin-map-fill');
                    ?>
                    
                    <h4 class="text-primary border-bottom pb-2 mt-5 mb-4"><i class="bi bi-check2-square me-2"></i> 3. อ้อยตอคงเหลือ</h4>

                    <?php
                    $section3_1_images = [
                        "remaining_cane_1_img_1" => "อ้อยคงเหลือ ครั้งที่ 1 (รูปที่ 1)",
                        "remaining_cane_1_img_2" => "อ้อยคงเหลือ ครั้งที่ 1 (รูปที่ 2)",
                    ];
                    createImageUploads("อ้อยตอคงเหลือ ครั้งที่ 1 (ก่อนตัด)", $section3_1_images, 'bi-basket-fill');
                    ?>
                    
                    <?php
                    $section3_2_images = [
                        "remaining_cane_2_img_1" => "อ้อยคงเหลือ ครั้งที่ 2 (รูปที่ 1)",
                        "remaining_cane_2_img_2" => "อ้อยคงเหลือ ครั้งที่ 2 (รูปที่ 2)",
                    ];
                    createImageUploads("อ้อยตอคงเหลือ ครั้งที่ 2 (กลางฤดู)", $section3_2_images, 'bi-basket-fill');
                    ?>
                    
                    <?php
                    $section3_3_images = [
                        "remaining_cane_3_img_1" => "อ้อยคงเหลือ ครั้งที่ 3 (รูปที่ 1)",
                        "remaining_cane_3_img_2" => "อ้อยคงเหลือ ครั้งที่ 3 (รูปที่ 2)",
                    ];
                    createImageUploads("อ้อยตอคงเหลือ ครั้งที่ 3 (สุดท้าย)", $section3_3_images, 'bi-basket-fill');
                    ?>
