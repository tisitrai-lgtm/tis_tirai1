...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom">
    <div class="container-fluid justify-content-between">
        <div class="navbar-header-group">
            ...
            <a class="navbar-brand" href="dashboard.php?year=<?php echo htmlspecialchars($selected_year); ?>">ระบบรูปประมาณตัน</a>
        </div>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo ($current_page === 'admin_summary_infographic.php') ? 'active-page' : ''; ?>" 
                        href="<?php echo $admin_summary_infographic_url; ?>">
