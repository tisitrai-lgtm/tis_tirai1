...
<head>
    ...
    @media (max-width: 767.98px) {
            ...
            /* ปรับปุ่มให้เล็กและใช้ไอคอนเท่านั้น */
            .btn-delete-image i {
    ...
    opacity: 1; /* ป้องกันเบราว์เซอร์ปรับความทึบ */
}
    </style>
</head>
<body>
        ...
        <form action="update_data.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-5">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="rai_area" name="rai_area" min="0" step="0.01" value="<?php echo htmlspecialchars($data['rai_area']); ?>" required readonly>
                </div>
            </div>
            ...
            createImageUploadsEdit("การประมาณตันอ้อยก่อนเปิดหีบ", $section1_images, $data, $basePath, $data['id'], 'bi-bar-chart-fill');
            ?>
            <div class="col-md-6"><label for="ton_rai" class="form-label">ตันต่อ (ไร่) <span class="text-danger">*</span></label>
                        <input type="number" class="form-control" id="ton_rai" name="ton_rai" min="0" step="0.01" value="<?php echo htmlspecialchars($data['ton_rai']); ?>" required>
                    </div>
            ...
            <div class="mt-4 mb-3 text-center">
                ...
                <a href="dashboard.php?year=<?php echo htmlspecialchars($selected_year); ?>" class="btn btn-secondary btn-lg shadow-sm" style="min-width: 180px;">
                    <i class="bi bi-arrow-left-circle-fill me-2"></i> ยกเลิก
                </a>
            </div>
        </form>
    </div>
