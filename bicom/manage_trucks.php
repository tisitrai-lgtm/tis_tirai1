...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .text-purple { font-size: 1rem; }
            .card-header .row { flex-direction: column; }
            .card-header .col-md-5, .card-header .col-md-3 { width: 100%; margin-top: 10px; }
            .input-group { width: 100%; }
            #rowLimit { width: 100% !important; text-align: center; }
            .table-responsive { border-radius: 15px; overflow-x: auto !important; -webkit-overflow-scrolling: touch; }
            .table { min-width: 600px; }
            .table th, .table td { padding: 12px 8px !important; font-size: 0.85rem; }
            .btn-delete { padding: 10px 15px; width: 100%; margin-bottom: 5px; }
            .header-gradient, .d-flex.justify-content-between.text-white { flex-direction: column; align-items: flex-start !important; padding: 1rem !important; }
            .d-flex.justify-content-between.text-white .bg-white { margin-top: 15px; width: 100%; }
            .card-body { padding: 1.5rem !important; }
            .suggest-box { position: fixed; bottom: 0; left: 0; width: 100%; margin-top: 0; border-radius: 20px 20px 0 0; max-height: 50vh; }
        }
    </style>
</head>
<body>
            ...
            <form action="save_report.php" method="POST" autocomplete="off">
                ...
                <div class="row g-3"> 
                    ...
                    <div class="col-6 col-md-2">
                        ...
                        <select name="owner_name" id="owner_name" class="form-control-custom w-100 fw-bold" required>
                            <option value="อ้อยลำ">อ้อยลำ</option>
                            <option value="อ้อยท่อน">อ้อยท่อน</option>
                        </select>
                    </div>
                    <div class="col-12 col-md-2 d-grid">
                        <label class="form-label d-none d-md-block">&nbsp;</label>
                        <button type="submit" id="btn_save" class="btn btn-save btn-lg" disabled><i class="bi bi-check-circle me-2"></i>บันทึก</button>
                    </div>
                </div>
            </form>
        </div>
...
trailInp.addEventListener('input', function() { applyTrailMask(this); });
    ...
    tableBody.innerHTML = paginatedItems.length > 0 ? paginatedItems.map(row => `
        <tr>
            ...
            <td class="text-center">
                <span class="badge ${row.owner_name === 'อ้อยท่อน' ? 'bg-primary' : 'bg-success'} px-3 rounded-pill">
