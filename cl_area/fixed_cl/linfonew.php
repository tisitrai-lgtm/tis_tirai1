...
<body>
    ...
    <div class="container-fluid">
        <div class="main-container">
            ...
            <div class="modal fade" id="uploadExcelModal" ... > </div>
            <div class="modal fade" id="insertFormModal" ... > </div>

            <div class="mb-4">
                <div class="info-display d-flex justify-content-center align-items-center">
                    <i class="bi bi-info-circle-fill me-2"></i>
                    <span>หน่วยงาน : <strong><?php echo htmlspecialchars($current_unit_name); ?></strong> 
                    <span class="mx-3">|</span> 
                    ปีการผลิต : <strong><?php echo htmlspecialchars($current_production_year_label); ?></strong></span>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table id="myTable" class="table table-hover align-middle">
                    ...
                    <tbody>
                        <?php foreach($land_info_data as $row): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a target="_blank" href="exportPDF.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-primary btn-sm">
            ...
            <div class="d-flex justify-content-end gap-3 mt-4">
                <button type="button" class="btn btn-modern-green" id="openInsertFormModalBtn" data-bs-toggle="modal" data-bs-target="#insertFormModal">
                    <i class="bi bi-plus-lg me-2"></i>บันทึกข้อมูลใหม่
                </button>
            </div>
        </div>
    </div>
